...
double P_0_5_constant( double x_0, double left_0, double amplitude, double omega, double time ) {
  return 0.5;
}
...
void piston_down() {
  ...
  auto dir_name = solver::solve_system_boundaries(x_0, x_n, time, N,
                                                  r_l, u_l, p_l,
                                                  amplitude, omega, P_0_5_constant, P_wave_function,
                                                  boundaries::piston, boundaries::soft, false,
                                                  limiter::none);
}
...
void two_waves_minmod() {
  ...
  auto dir_name = solver::solve_system_boundaries(x_0, x_n, time, N,
                                                  r_l, u_l, p_l,
                                                  amplitude, omega, P_function_1_GAMMA_one_positive_wave, P_wave_function,
                                                  boundaries::piston, boundaries::piston, false,
                                                  limiter::none);
}
